...
};gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDNewButtonObjects1Objects = Hashtable.newFrom({"NewButton": gdjs.GameSceneCode.GDNewButtonObjects1});
...
{for(var i = 0, len = gdjs.GameSceneCode.GDGoldTextObjects1.length ;i < len;++i) {
    gdjs.GameSceneCode.GDGoldTextObjects1[i].getBehavior("Text").setText("$INPAK: " + runtimeScene.getScene().getVariables().getFromIndex(2).getAsString());
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("NewButton"), gdjs.GameSceneCode.GDNewButtonObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDNewButtonObjects1Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://x.com/indiapakistan_", runtimeScene);
}}
